...
const variants: Record<ButtonVariant, string> = {
    ...
    secondary: [
        ...
        "active:translate-y-[1px]",
        // anel claro separando do fundo do app
        "focus-visible:ring-white",
...
function ButtonContent({
    ...
    rightIcon,
    children,
}: Pick<ButtonProps, "leftIcon" | "rightIcon"> & { children: React.ReactNode }) {
    return (
        <>
            ...
            <Link
                ...
                onClick={
                    disabled
                        ? (e) => e.preventDefault()
                        : (onClick
                            ? ((e) => (onClick as unknown as React.MouseEventHandler<HTMLAnchorElement>)(e))
                            : undefined)
                }
            >
